...
\hypobox{Logs are more likely to be changed during complex bugs fixes. After normalizing the complexity of bugs using code churn, we find that bug fixes with log churn are resolved faster with fewer people and fewer discussions.}
