...
\begin{table}[t]
	...
	\begin{tabular}{|l|lll|}
		\hline 
		\multirow{1}{*}{Projects} & \multicolumn{1}{c}{Hadoop} & \multicolumn{1}{c}{HBase} & \multicolumn{1}{c|}{Qpid}\tabularnewline
		\hline 
		\multirow{1}{.3\textwidth}{Modified log density ratio} & 1.9 & 3.5 & 4.1\tabularnewline
		%		\hline 
		\multirow{1}{*}{New log density ratio} & 1.4 & 1.2 & 1.2\tabularnewline
		%		\hline 
		\multirow{1}{*}{Deleted log density} & 1.6 & 2.5 & 0.5\tabularnewline

		\multirow{1}{*} {Log relocation density ratio} & 2.0 & 3.3 & 4.9\tabularnewline

		\multirow{1}{*}{Text modification density ratio} & 2.5 & 6.5 & 11.1\tabularnewline
	 			
		\multirow{1}{*}{Variable modification density ratio} & 2.0 & 1.7 & 4.4\tabularnewline

		\multirow{1}{*}{Logging level density ratio} & 4.0 & 7.5 & 15.8\tabularnewline

		\multirow{1}{*}{Variable addition density ratio} & 2.7 & 1.3 & 25.5\tabularnewline

		\multirow{1}{*}{Variable deletion density ratio} & 2.6 & 1.6 & 4.6\tabularnewline

		\multirow{1}{*}{Variable modification density ratio} & 2.9 & 0.8 & 4.7\tabularnewline
			\hline 				
	\end{tabular}
	\label{tba:logdensityNewLogs}
\end{table}
